# ==========================================================
# Matcha PPO Baseline — Versioned Logging System
# ----------------------------------------------------------
# Each version tag (v1, v2, v3...) gets its own subfolder.
# ==========================================================
...
# ========== GLOBAL CONFIG ==========
VERSION_TAG = "v1_baseline_state"     # 🔁 change this for new experiments
SEED = 42
URDF_PATH = r"D:\FULBRIGHT\FALL 2025\git_robot\matcha\Matcha\hardware\balance_robot.urdf"

# Main log path organized by version
...
if __name__ == "__main__":
    ...
    metadata = {
        ...
        "policy_arch": [256, 256],
        "max_episode_steps": MAX_EPISODE_STEPS,
        "notes": "Baseline PPO run — symmetric torque, no vision.",
    }
